...
class FrontAppController extends AppController {
    ...
    public function beforeFilter() {
        ...
        if ($_SERVER['SERVER_NAME'] != 'www.backyard-salon.com' && $_SERVER['SERVER_NAME'] != 'backyard-salon.com') {
            echo "Sorry!! You cannot install this source on the other sites."; exit;
        }
        ...
        $arrDispCategory = Configure::read('arrCategory');
        $this->set('arrDispCategory', $arrDispCategory);
